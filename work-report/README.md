...
| 경로 | 메뉴 | 하는 일 |
|---|---|---|
| `/` | 오늘현황 | 오늘 기록 현황, 마감 임박 업무, 보고서 만들기 바로가기 |
| `/tasks` | 단위업무 | 업무 등록·수정·보관, 업무 유형 관리 |
| `/daily` | 일일업무 | 날짜별 진행 내역과 세부내용 입력 |
| `/weekly` | 주간업무 | 주차별 전주 실적 / 금주 예정 관리 |
| `/series` | 개발현황 | 시리즈 추가·삭제·순서·색, 단계별 진행률 입력 (총 진행률 자동 계산) |
| `/reports` | 보고서 | 보고서 생성, 미리보기, 드라이브 저장, 내려받기, 이력 |
